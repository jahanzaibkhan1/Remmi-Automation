...
import { ContactLeadFormPage as ContactPage } from '../../pages/contacts/ContactLeadFormPage';
...
test.describe('Contacts "Lead Form" Tab - E2E Tests', () => {
    ...
    test('Verify that clicking the save button saves the lead but does not close the form', async ({ sessionPage }) => {
        const contact = new ContactPage(sessionPage);

...
export class ListingGridViewPage extends ListingBasePage {
    ...
    async selectNextDateFromToday() {
        ...
        // Read currently opened calendar's month-year (stable header)
        ...
        // Select tomorrow's date (non-flaky selector)
